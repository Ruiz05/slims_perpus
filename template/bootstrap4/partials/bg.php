...
<div class="s-background animated fadeIn">
    ...
    <video loop autoplay muted>
        <source src='<?php echo $sysconf['template']['dir']; ?>/bootstrap4/video/bg.mp4' type='video/mp4' />
        Your browser does not support the video tag.
    </video>
    <?php elseif($sysconf['template']['background_mode'] == 'image') : ?>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/bootstrap4/img/4.jpg'/>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/bootstrap4/img/3.jpg'/>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/bootstrap4/img/2.jpg'/>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/bootstrap4/img/1.jpg'/>
         <!-- ],
