...
<br>
  <!-- Availability
  ============================================= -->  
  <h4><i class="fa fa-check-circle mr-2"></i> <?php echo __('Availability'); ?></h4>
  ...
  <h4><i class="fa fa-info-circle mr-2"></i> <?php echo __('Detail Information'); ?></h4>
  <div class="row">
  <div class="col-lg-12">  
...
<br>
  <!-- Related biblio data
  ============================================= -->  
  <h4><i class="fa fa-files-o mr-2"></i> <?php echo __('Other version/related'); ?></h4>
  ...
  <h4><i class="fa fa-comments-o mr-2"></i> <?php echo __('Comments'); ?></h4>
